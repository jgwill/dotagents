...
tags:
  ...
  - composition-browser
description: >
  Browse, inspect, and decompose composition recordings using composition-browser
  and miaco decompose composition. Reads transcriptions, classifies form and intent,
  routes to decomposition strategies, and produces PDE artifacts via LLM engines.
---

# Composition Decompose Skill
